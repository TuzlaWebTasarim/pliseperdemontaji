export default function MobileBar() {
  return (
    ...
    >
      <div className="flex h-[60px] shadow-2xl">
        <a
          href="tel:+905403363873"
          className="flex-1 flex items-center justify-center gap-2 bg-slate text-white font-bold text-[14px] hover:bg-[#353e4c] transition-colors active:scale-95"
          aria-label="Telefon ile ara: 0540 336 38 73"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-[14px] hover:bg-[#1ebe5d] transition-colors active:scale-95"
